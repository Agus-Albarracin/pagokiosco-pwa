...
import { kilogramsToGrams, type Product } from "@/entities/product";
import { lineCents } from "@/entities/sale";
...
import { addStock, recordWaste } from "@/features/inventario/stock";
