...
function Workspace() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      <Link href="/" className="brand"><span className="brand-mark">pk</span>PagoKiosco<span className="badge">MVP</span></Link>
      <p className="sidebar-caption">TU NEGOCIO, AL DÍA</p>
      <WorkspaceNav view={view} onChange={next => { setView(next); setNotice(""); }} />
      <p className="sidebar-foot">Hecho para tu mostrador.<br />Tus datos quedan en este dispositivo.</p>
    </aside>
    <main id="main">
      <header className="topbar">
        <span>Mi kiosco <span className="muted">/ {heading.breadcrumb}</span></span>
